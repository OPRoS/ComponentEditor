...
public class OPRoSEventOutPortElementModel extends OPRoSPortElementBaseModel {
	public OPRoSEventOutPortElementModel(){
		super();
		initializeData();
	}
	public void initializeData(){
		super.initializeData();
		setUsage(OPRoSStrings.getString("EventOutEleUsageDefault"));
	}
