...
public class OPRoSServiceProvidedPortElementFigure extends Figure {
...
//	private FlowLayout layout;
	...
	public Image getWidgetImage(){
		if(direction==1)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("ServiceProvidedFigureE"));
		else if(direction==2)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("ServiceProvidedFigureW"));
		else if(direction==3)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("ServiceProvidedFigureS"));
		else if(direction==4)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("ServiceProvidedFigureN"));
		return icon;
	}
	public OPRoSServiceProvidedPortElementFigure(){
		direction=4;
		layout = new XYLayout();
		...
		label.setFont(new Font(null,OPRoSStrings.getString("ServiceProvidedFigureFont"),10,SWT.NONE));
