...
public class OPRoSEventOutPortElementFigure extends Figure {
	...
	public Image getWidgetImage(){
		if(direction==1)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("EventOutFigureE"));
		else if(direction==2)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("EventOutFigureW"));
		else if(direction==3)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("EventOutFigureS"));
		else if(direction==4)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("EventOutFigureN"));
		return icon;
	}
	public OPRoSEventOutPortElementFigure(){
		direction=4;
		layout = new XYLayout();
		...
		label.setFont(new Font(null,OPRoSStrings.getString("EventOutFigureFont"),10,SWT.NONE));
