...
public class OPRoSRSENewConnectionWizard extends Wizard implements INewWizard, ISelectionProvider {
	...
	private OPRoSRSENewConnectionWizardSelectionPage mainPage;
	...
	public OPRoSRSENewConnectionWizard(){
		super();
		setWindowTitle("OPRoS New Host Connection");
		...
		selectedWizard = null;
		mainPage = new OPRoSRSENewConnectionWizardSelectionPage(wizardRegistry);
...
//				try {
//					hosts[i].getSubSystems()[0].connect(new NullProgressMonitor(), true);
//				} catch (Exception e) {
//					e.printStackTrace();
//				}
//			}
