...
public class OPRoSDataOutPortElementFigure extends LabeledFigure {
	...
	public Image getWidgetImage(){
		if(direction==1)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("DataOutFigureE"));
		else if(direction==2)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("DataOutFigureW"));
		else if(direction==3)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("DataOutFigureS"));
		else if(direction==4)	
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("DataOutFigureN"));
		return icon;
	}
	public OPRoSDataOutPortElementFigure(){
		direction=4;
		layout = new XYLayout();
		...
		label.setFont(new Font(null,OPRoSStrings.getString("DataOutFigureFont"),10,SWT.NONE));
