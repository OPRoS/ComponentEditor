 ...
 *
 */
public class ArchiveFileExportOperationEx implements IRunnableWithProgress {
     ...
     */
    public ArchiveFileExportOperationEx(List resources, String filename) {
        super();
     ...
     *  @param filename java.lang.String
     */
    public ArchiveFileExportOperationEx(IResource res, String filename) {
        super();
        resource = res;
        destinationFilename = filename;
    }
     ...
     *  @param filename java.lang.String
     */
    public ArchiveFileExportOperationEx(IResource res, List resources, String filename) {
        this(res, filename);
        resourcesToExport = resources;
    }
