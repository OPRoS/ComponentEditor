...
public class OPRoSRSENewConnectionWizardSelectionPage extends WizardPage {
...
//	private RSENewConnectionWizardSelectionTreeDataManager filteredTreeDataManager;
	private OPRoSRSENewConnectionWizardSelectionTreeDataManager filteredTreeDataManager;

	/**
	 * Internal class. The wizard state filter is responsible to filter
	 * out any not enabled or filtered wizard from the tree.
	 */
	private class OPRoSNewConnectionWizardStateFilter extends ViewerFilter {
	 ...
	 * categories.
	 */
	private class OPRoSNewConnectionWizardViewerComparator extends ViewerComparator {
	 ...
	 */
	public OPRoSRSENewConnectionWizardSelectionPage(RSENewConnectionWizardRegistry wizardRegistry) {
...
//	 */
//	public OPRoSRSENewConnectionWizardSelectionPage() {
...
//		return SystemResources.RESID_NEWCONN_MAIN_PAGE_TITLE;
		return "Select Remote System Type of Robot";
	}
...
//		return SystemResources.RESID_NEWCONN_MAIN_PAGE_DESCRIPTION;
		return "Please select the system type of the remote system to connnect.";
	}
	...
	public void createControl(Composite parent) {
		...
		label.setText("System type" + ":"); //$NON-NLS-1$
		label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
...
//		filteredTree = new FilteredTree(composite, SWT.SINGLE | SWT.H_SCROLL | SWT.V_SCROLL | SWT.BORDER, filteredTreeFilter);
		filteredTree = new FilteredTree(composite, SWT.SINGLE | SWT.H_SCROLL | SWT.V_SCROLL | SWT.BORDER, filteredTreeFilter, false);
		...
		treeViewer.setComparator(new OPRoSNewConnectionWizardViewerComparator());

		filteredTreeWizardStateFilter = new OPRoSNewConnectionWizardStateFilter();
...
//		filteredTreeDataManager = new RSENewConnectionWizardSelectionTreeDataManager(wizardRegistry);
		filteredTreeDataManager = new OPRoSRSENewConnectionWizardSelectionTreeDataManager(wizardRegistry);
