...
public class OPRoSServiceRequiredPortElementFigure extends Figure {
	...
	public Image getWidgetImage(){
		if(direction==1)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("ServiceRequiredFigureE"));
		else if(direction==2)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("ServiceRequiredFigureW"));
		else if(direction==3)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("ServiceRequiredFigureS"));
		else if(direction==4)
			icon = OPRoSUtil.createImage(OPRoSStrings.getString("ServiceRequiredFigureN"));
		return icon;
	}
	public OPRoSServiceRequiredPortElementFigure(){
		direction=4;
		layout = new XYLayout();
		...
		label.setFont(new Font(null,OPRoSStrings.getString("ServiceRequiredFigureFont"),10,SWT.NONE));
